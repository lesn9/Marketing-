...
# One model per provider — Railway value is authoritative
GROQ_MODEL = env("GROQ_MODEL", default="llama-3.1-8b-instant")
GROQ_MODEL_2 = env("GROQ_MODEL_2", default="")  # optional; falls back to GROQ_MODEL
...
BUILD = "2026-09-25-mkt-ai-router-clean-v9"
